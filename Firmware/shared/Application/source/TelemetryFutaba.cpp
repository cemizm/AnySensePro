...
void TelemetryFutaba::Init()
{
	...
	if (m_config->IsValid != ConfigKey)
	{
		...
		m_config->Slots[3] = SlotValue::Current;
		m_config->Slots[6] = SlotValue::Cell;
		m_config->Slots[8] = SlotValue::GPS;
		m_config->Slots[16] = SlotValue::Kompass;
		m_config->Slots[17] = SlotValue::Sats;
		m_config->Slots[18] = SlotValue::Flightmode;
		m_config->Slots[19] = SlotValue::Temperatur;
