...
Generated from: AnySense.xml,common.xml
    ...
    namespace MavLink
{
	...
	/// 
	/// </summary>
	public enum CONFIG_COMMAND : ushort
	{
	...
	/// 
	/// </summary>
	public enum CONFIG_PORT : ushort
	{
	...
	/// 
	/// </summary>
	public enum CONFIG_PROTOCOL : ushort
	{
...
namespace MavLink
{
	...
	public class Msg_configuration_version3 : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_CONFIGURATION_VERSION3(this, bytes, ref offset);
            }        
	}
