...
namespace MavLink
{
    ...
    public static class MavLinkSerializer
    {
		...
		internal static MavlinkMessage Deserialize_CONFIGURATION_VERSION3(byte[] bytes, int offset)
		{
			return new Msg_configuration_version3
			{
				fw_version = bitconverter.ToUInt32(bytes, offset + 0),
		...
		internal static int Serialize_CONFIGURATION_VERSION3(this Msg_configuration_version3 msg, byte[] bytes, ref int offset)
		{
			bitconverter.GetBytes(msg.fw_version, bytes, offset + 0);
